...
//    public Cart getNewCart(@RequestBody User user) {
//        return cartService.getNewCart(user);
//    }

    @RequestMapping(method = RequestMethod.GET, value = "getProductsFromCart")
    public List<Product> getProductsFromCart(@RequestBody CartDto cartDto) {
...
//    public boolean deleteProductFromCart(@RequestBody CartDto cartDto, Product product) {
